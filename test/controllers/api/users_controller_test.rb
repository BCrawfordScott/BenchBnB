...
class Api::UsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create api_user" do
    assert_difference('Api::User.count') do
      post api_users_url, params: { api_user: { email: @api_user.email, password_digest: @api_user.password_digest, session_token: @api_user.session_token, username: @api_user.username } }
    end
  ...
  test "should update api_user" do
    patch api_user_url(@api_user), params: { api_user: { email: @api_user.email, password_digest: @api_user.password_digest, session_token: @api_user.session_token, username: @api_user.username } }
